...
public class CheckpointManagerTest {
    ...
    public void shouldThrowNullPointerExceptionWhenCheckpointsInUnknownFormat() throws IOException {
        expect(params.getId()).andReturn("org/bitcoincashj/core/checkpointmanagertest/unsupportedFormat");
        replay(params);
        new CheckpointManager(params, null);
    }
    ...
    public void shouldThrowIllegalStateExceptionWithNoCheckpoints() throws IOException {
        expect(params.getId()).andReturn("org/bitcoincashj/core/checkpointmanagertest/noCheckpoints");
        replay(params);
        new CheckpointManager(params, null);
    }
    ...
    public void canReadTextualStream() throws IOException {
        expect(params.getId()).andReturn("org/bitcoincashj/core/checkpointmanagertest/validTextualFormat");
